...
# write.table(AnnoDF,file = "20210108.InputAnnovar.txt",col.names = F,quote = F,row.names = F)

#- run following lines to setup for annovar
# cd '/Users/deepankar/Documents/Seafile/NGS_Seq_Tools/annovar2'
# ln -s "/Users/deepankar/Documents/Seafile/NGS-Data-DC/BaseSpace/20201125 Marika ERBB3 iSCREAM/Analysis/Annovar/20210108.InputAnnovar.txt" "20210108.InputAnnovar.txt"

#- Run annovar
# script 20210108.ERBB3.iSCREAM.log command ./table_annovar.pl 20210108.InputAnnovar.txt humandb -buildver hg19 -out ERBB3.iSCREAM.V1 -remove -protocol refgene,gnomad211_exome,gnomad211_genome,avsnp150,clinvar_20190305 -operation g,f,f,f,f -nastring . -csvout -polish

# minimal annotations
# annotate_variation.pl -out ERBB2.txt --build hg19 20190103.InputAnnovar.txt humandb

#- Copy annotations
# mv 20210108.ERBB3.iSCREAM.log ERBB3.iSCREAM.V1.hg19_multianno.csv "/Users/deepankar/Documents/Seafile/NGS-Data-DC/BaseSpace/20201125 Marika ERBB3 iSCREAM/Analysis/Annovar/."

rm(AnnoDF,Mutation.Table)
var=read.table("ERBB3.iSCREAM.V1.hg19_multianno.csv",sep=",",stringsAsFactors = F,header = T)
var$MutID=paste(var$Chr,":",var$Start,var$Ref,">",var$Alt,sep="")
saveRDS(object = var,file = "ERBB3.iSCREAM.V1.hg19_multianno.RDS")
#-----------
